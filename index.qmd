...
[**What**]{style="color:#edea2b"} is R (and RStudio)?
...
[**Why**]{style="color:#edea2b"} use R (and RStudio)?
...
[**How**]{style="color:#edea2b"} do I get R (and RStudio)?
...
#| echo: true
#| eval: false
download.file('https://www.dropbox.com/s/ghralb2cmkp562w/penguins.csv?dl=1')
    ```
