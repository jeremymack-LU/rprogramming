...
* You need R to run RStudio, but not RStudio to run R. 
...
[[**How**]{style="color:#edea2b"} do I work with R (and RStudio)?]{style="font-size: 1.5em; text-align: center"}

## Topic 4: [**How**]{style="color:#edea2b"} do I work with R (and RStudio)? {data-menu-title="Working with R"} 