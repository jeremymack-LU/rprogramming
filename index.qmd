...
-   By the end of this presentation, you should know about...
    ...
    3.  R Environment
        ...
        - Reading ([tidy]{style="color:#edea2b"}) data
:::
...
-   R packages come with pre-loaded datasets.
![](images/tidydata.jpg){.absolute bottom="0" right="0" height="35%"}
...
::: fragment
![](images/tidydata3.jpg){.absolute bottom="-12" right="0" height="35%"}
:::
