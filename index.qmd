...
-   By the end of this presentation, you should know about...
    ...
    3.  Objects and functions and how they work together
    4.  Working directories
    5.  Loading data into the R Environment
    6.  Exporting data from the R Environment
:::
...
::: {.column width="33%"}
![](images/rlang_hex.png){width="32%"} ![](images/rstudio_hex.png){width="32%"} ![](images/tidyverse_hex.png){width="32%"}
:::
:::
...
-   Topic 7:    Extras
    ...
    -   RStudio Projects and Additional Resources
:::
...
```
### RStudio IDE
![](images/explorer1.png){.absolute bottom="0" left="0" height="50%"}
:::
:::
...
-   First, try the following:
    ...
    1. Set your working directory to the Desktop.
    2. Download the file [penguins.csv]{style="color:#edea2b"} using the following command:
    ```{r}
#| echo: true
#| eval: false
download.file('https://www.dropbox.com/s/pyzzrpkvf76f4t6/penguins.csv?dl=1', 'penguins.csv')
    ```

::: fragment
-   Next, try these additional steps:

    1. Install and load the Tidyverse package `readr`.
    2. Using the `read_csv` function, read in penguins.csv.
    3. Assign the [body_mass_g]{style="color:#edea2b"} variable to an object.
    4. Use this object to find the heaviest weight.
:::

::: fragment
-   Finally, try the following:

    1. Create a folder on the Desktop called Data.
    2. Assign the first 100 rows of the penguin data set to an object, using the `head` function.
    3. Write it to a .csv file within your new Data folder.
:::
...
#| echo: true
#| eval: false
# Set working directory to Desktop and download file
setwd('C:/Users/jsm4/Desktop')
download.file('https://www.dropbox.com/s/pyzzrpkvf76f4t6/penguins.csv?dl=1', 'penguins.csv')
```
:::
:::
...
df <- read_csv('C:/Users/jsm4/Desktop/penguins.csv')  # Absolute path
df <- read_csv('penguins.csv')                        # Relative path
```
:::
:::
...
write.csv(df_subset,'Data/penguins_subset.csv')
...
[Extras - RStudio Projects and Additional Resources]{style="font-size: 1.5em; text-align: center"}

## Topic 7: Extras - RStudio Projects and Additional Resources {data-menu-title="Extras"}