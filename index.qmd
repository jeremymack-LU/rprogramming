...
-   Finally, try the following:
    ...
    3. Write it to a .csv file within your new Data folder, using the `write.csv` function.
:::
...
## Topic 7: Extras - RStudio Projects {data-menu-title="RStudio Projects"}

## Topic 7: Extras - Additional Resources {data-menu-title="Additional Resources"}